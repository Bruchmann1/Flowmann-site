  ...
  <div style="background:#fff;border-radius:14px;border:1px solid #e5e1d5;overflow:hidden">
    <div style="padding:28px 28px 0">
      <table cellpadding="0" cellspacing="0" style="border-collapse:collapse"><tr>
        <td style="vertical-align:middle"><img src="https://flowmann.com/favicon-96x96.png" width="34" height="34" alt="Flowmann" style="display:block;border-radius:9px;border:0;outline:none;-ms-interpolation-mode:bicubic"></td>
